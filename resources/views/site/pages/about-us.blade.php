            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="latest-match-box mb-30">
                            <div class="latest-match-thumb">
                                <img src="{{ asset('site/img/images/latest_match_thumb01.jpg') }}" alt="">
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="latest-match-box mb-30">
                            <div class="latest-match-thumb">
                                <img src="{{ asset('site/img/images/latest_match_thumb02.jpg') }}" alt="">
                            </div>
                            <div class="tournament-schedule-content">
                    ...
                    <div class="col-lg-6">
                        <div class="latest-match-box mb-30">
                            <div class="latest-match-thumb">
                                <img src="{{ asset('site/img/images/latest_match_thumb03.jpg') }}" alt="">
                            </div>
                            <div class="tournament-schedule-content">
                    ...
                    <div class="col-lg-6">
                        <div class="latest-match-box mb-30">
                            <div class="latest-match-thumb">
                                <img src="{{ asset('site/img/images/latest_match_thumb04.jpg') }}" alt="">
                            </div>
                            <div class="tournament-schedule-content">
