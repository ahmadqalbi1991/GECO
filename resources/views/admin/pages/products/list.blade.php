                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        <div>
                                                            <img src="{{ asset('products/' . $product->image) }}" class="avatar avatar-sm me-3">
                                                        </div>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <form action="{{ route('admin.products.update', $product->id) }}" method="post">
                                                        ...
                                                        <button type="submit" class="btn btn-sm bg-gradient-{{ $product->is_active ? 'success' : 'danger' }}">{{ $product->is_active ? 'Active' : 'Deactive' }}</button>
                                                    </form>
                                                </td>
                                                ...
                                                <td class="align-middle" style="display: flex">
                                                    ...
                                                    <a href="{{ route('admin.products.show', $product->id) }}" class="badge btn-secondary btn-sm m-r-5">
